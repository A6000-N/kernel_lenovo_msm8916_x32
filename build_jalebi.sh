...
DEFCONFIG="phantom_jalebi_defconfig"
KERNEL="zImage"

#Hyper Kernel Details
BASE_VER="Phantom"
VER="-jalebi-$(date +"%Y-%m-%d"-%H%M)-"
...
# Paths
KERNEL_DIR=`pwd`
RESOURCE_DIR="/home/android/kernel/a6000"
...
case "$echoice" in
	1 )
		export CROSS_COMPILE=$TOOLCHAIN_DIR/gcc-prebuilts/bin/arm-linaro-linux-gnueabi-
		export LD_LIBRARY_PATH=$TOOLCHAIN_DIR/gcc-prebuilts/lib/
		TC="SM"
		rm -rf $MODULES_DIR/*
		rm -rf $ZIP_MOVE/*
